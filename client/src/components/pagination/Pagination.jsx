                ...
                return (
                  <li key={number}>
                    <button
                      ...
                      //className={style.paginationCurrentPage}
